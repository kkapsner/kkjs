...
register("indexOf", function arrayIndexOf(searchElement/*, fromIndex*/){
	var len = this.length;
	if (len === 0){
		return -1;
	}
...
register("lastIndexOf", function arrayLastIndexOf(searchElement/*, fromIndex*/){
	var len = this.length;
	if (len === 0){
		return -1;
	}
...
register("every", function arrayEvery(callbackFn/*, thisArg*/){
	var len = this.length;
...
register("some", function arraySome(callbackFn/*, thisArg*/){
	var len = this.length;
	if (typeof callbackFn !== "function"){
		throw new TypeError();
	}
...
register("forEach", function arrayForEach(callbackFn/*, thisArg*/){
	var len = this.length;
	if (typeof callbackFn !== "function"){
		throw new TypeError();
	}
...
register("map", function arrayMap(callbackFn/*, thisArg*/){
	var len = this.length;
	if (typeof callbackFn !== "function"){
		throw new TypeError();
	}
...
register("filter", function arrayFilter(callbackFn/*, thisArg*/){
	var len = this.length;
	if (typeof callbackFn !== "function"){
		throw new TypeError();
	}
...
register("reduce", function arrayReduce(callbackFn/*, initialValue*/){
	var len = this.length;
	if (typeof callbackFn !== "function"){
		throw new TypeError();
	}
...
register("reduceRight", function arrayReduceRight(callbackFn/*, initialValue*/){
	var len = this.length;
	if (typeof callbackFn !== "function"){
		throw new TypeError();
	}
